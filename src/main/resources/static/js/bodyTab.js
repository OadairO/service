        ...
        for(var i=0;i<data.length;i++){
            ...
            if(data[i].children != undefined && data[i].children.length > 0){
                ...
                if(data[i].icon != undefined && data[i].icon != ''){
                    ulHtml += '<i class="fa '+data[i].icon+' fa-lg"></i>';
                }
                ...
                for(var j=0;j<data[i].children.length;j++){
                    if(data[i].children[j].target == "_blank"){
                    	if(data[i].children[j].href !=null && data[i].children[j].href != ""){
                    		ulHtml += '<dd><a data-url="'+data[i].children[j].href+"?userid="+globalUserData.id+'" target="'+data[i].children[j].target+'">';
                    	}else {
                    		ulHtml += '<dd><a data-url="'+data[i].children[j].href+'" target="'+data[i].children[j].target+'">';
						}
                    }else{
                    	if(data[i].children[j].href !=null && data[i].children[j].href != ""){
                    		ulHtml += '<dd><a data-url="'+data[i].children[j].href+"?userid="+globalUserData.id+'">';
                    	}else{
                    ...
                    if(data[i].children[j].icon != undefined && data[i].children[j].icon != ''){
                       /* if(data[i].children[j].icon.indexOf("icon-") != -1){
                        ...
                        ulHtml += '<i class="fa '+data[i].children[j].icon+' fa-lg" ></i>';
                    }
                ...
                if(data[i].target == "_blank"){
                	if(data[i].href !=null && data[i].href != ""){
                		 ulHtml += '<a data-url="'+data[i].href+"?userid="+globalUserData.id+'" target="'+data[i].target+'">';
                	}else {
                	...
                	if(data[i].href !=null && data[i].href != ""){
                		 ulHtml += '<a data-url="'+data[i].href+"?userid="+globalUserData.id+'">';
                	}else {
