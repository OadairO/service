...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['火速围观'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">占无公告</span></p></div>',
        ...
        layer.open({
            ...
            success : function(index, layero){
                ...
                form.on('switch(multipleLogin)', function(data){
                    layer.tips('温馨提示：该功能还未完善！', data.othis,{tips: 1})
                });
                form.render();  //表单渲染
            }
        })
