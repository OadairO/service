layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'productName', title: '文章标题', width:350},
            {field: 'userName', title: '发布者', align:'center'},
            {field: 'productStatus', title: '文章状态',  align:'center',templet:"#productStatus"},
            ...
            {field: 'newsType', title: '文章类别', align:'center', templet:function(d){
            	if(d.newsType == 0) return "---";
            	if(d.newsType == 1) return "技术要领";
            	if(d.newsType == 2) return "行业质询";
            }},
